Rails.application.routes.draw do
  ...
  get "users/:id/password_reset" => "users#password_reset"
  ...
  get "shops/:id/add_item" => "shops#add_item"
  post "shops/:id/create_item" => "shops#create_item"
  get "shops/:id/show_item" => "shops#show_item"
  post "shops/:id/:item_id/destroy_item" => "shops#destroy_item"
  get "shops/:id/:item_id/edit_item" => "shops#edit_item"
  post "shops/:id/:item_id/update_item" => "shops#update_item"
